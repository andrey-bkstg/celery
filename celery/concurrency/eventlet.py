...
@gen.coroutine
def _apply_target(target, args=(), kwargs={}, callback=None,
...
def apply_target(target, args=(), kwargs={}, callback=None, accept_callback=None, getpid=None):
    return _apply_target(target, args, kwargs, callback, accept_callback, pid=getpid())
